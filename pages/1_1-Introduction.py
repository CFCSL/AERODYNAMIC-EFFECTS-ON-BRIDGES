...
All references to BS 5400: Part 2 are intended to imply the document as implemented by BD 37(2) (DMRB 1.3).""")
This Standard is applicable to all highway bridges and foot/cycle-track bridges. However its provisions shall only apply to bridges which comply with the constraints outlined herein.
